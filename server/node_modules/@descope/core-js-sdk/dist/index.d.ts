...
declare const _default: ((config: Omit<{
    ...
    oauth: {
        start: {
            facebook: <B extends {
                redirect: boolean;
            }>(redirectURL?: string, config?: B) => Promise<SdkResponse<URLResponse>>;
            github: <B extends {
                redirect: boolean;
            }>(redirectURL?: string, config?: B) => Promise<SdkResponse<URLResponse>>;
            google: <B extends {
    ...
    flow: {
        start: (flowId: string, options?: Options, conditionInteractionId?: string, interactionId?: string, input?: FlowInput, version?: number) => Promise<SdkResponse<FlowResponse>>;
        next: (executionId: string, stepId: string, interactionId: string, input?: FlowInput, version?: number) => Promise<SdkResponse<FlowResponse>>;
    };
